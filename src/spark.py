...
class Spark:
    ...
    def render(self, surf, offset=(0, 0)):
        render_points = [
            ...
            (self.pos[0] - math.cos(self.angle + math.pi * 0.5) * self.speed - offset[0],
             self.pos[1] + math.sin(self.angle + math.pi * 0.5) * self.speed - offset[1]),

            (self.pos[0] - math.cos(self.angle + math.pi) * self.speed * 3 - offset[0],
             self.pos[1] + math.sin(self.angle + math.pi) * self.speed * 3 - offset[1]),

            (self.pos[0] - math.cos(self.angle + math.pi * 1.5) * self.speed - offset[0],
             self.pos[1] + math.sin(self.angle + math.pi * 1.5) * self.speed - offset[1]),
        ]
